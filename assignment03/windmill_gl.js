function setup() {
    ...
    drawblade("orange",Tred_to_canvas);
    //var Tred_rotate = mat3.create();
    mat3.rotate(Tred_to_canvas,Tred_to_canvas,-Math.PI/2);
    drawblade("blue",Tred_to_canvas);
